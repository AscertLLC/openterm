...
import com.ascert.open.term.i3270.Tn3270StreamParser;
...
public class StreamParserTest extends TestCase {
    ...
    public void testInit() throws Exception {
        ...
        Term3270 rw = new Term3270();
        rw.setClient(client);
        Tn3270StreamParser parser = new Tn3270StreamParser(rw);
...
/**
 * Implements methods from the <code>TnAction</code> interface. Use this
 adapter as a stub parent class where the objects implementing TnAction
 are required.
 *
 * @see TnAction
 */
class RWTnActionAdapter implements TnAction {
    private static final Logger log = Logger.getLogger("com.ascert.open.term.core.StreamParserDump");
    ...
    public void dumpLog(Term3270 rw) {
        if (log.isLoggable(logLevel)) {
